...
// use alloc::boxed::Box;
// use alloc::vec::Vec;
// use alloc::borrow::{Cow, ToOwned, Borrow};
...
// pub type CChar = u8;
//
// pub unsafe fn str_len(cstr_ptr: *const u8) -> usize {
//     let mut index = 0;
...
// }
//
// pub unsafe fn cstr_len(cstr_ptr: *const u8) -> usize {
//     str_len(cstr_ptr) + 1
// }
//
// fn byte_position(byte: u8, bytes: &[u8]) -> Option<usize> {
//     let mut pos = None;
//     for (idx, i_byte) in bytes.iter().enumerate() {
//         if *i_byte == byte {
//             pos = Some(idx);
//             break
//         }
...
// ///
// /// ```ignore (extern-declaration)
// /// use kernel_api::cstr::{CString, CStr};
// /// use std::os::raw::c_char;
// ///
// /// fn work(data: &CStr) {
...
// ///
// /// ```
// /// use kernel_api::cstr::{CString, NulError};
// ///
...
// ///
// /// ```
// /// use kernel_api::cstr::{CStr, FromBytesWithNulError};
// ///
...
// /// use kernel_api::cstr::{CString, FromVecWithNulError};
// ///
...
//     /// }
//     /// ```
//     pub unsafe fn from_raw(ptr: *mut CChar) -> CString {
//         let len = cstr_len(ptr); // Including the NUL byte
//         let slice = slice::from_raw_parts_mut(ptr, len as usize);
//         CString { inner: Box::from_raw(slice as *mut [CChar] as *mut [u8]) }
//     }
//
...
//     /// ```
//     #[inline]
//     pub fn into_raw(self) -> *mut CChar {
//         Box::into_raw(self.into_inner()) as *mut CChar
//     }
//
...
//
//                 let ptr: *mut NonZeroU8 = v.as_ptr() as *mut NonZeroU8;
//                 let len = v.len();
//                 let cap = v.capacity();
//
...
//     /// # }
//     /// ```
//     pub unsafe fn from_ptr<'a>(ptr: *const CChar) -> &'a CStr {
//         let len = cstr_len(ptr);
//         let ptr = ptr as *const u8;
//         CStr::from_bytes_with_nul_unchecked(slice::from_raw_parts(ptr, len as usize))
//     }
//
...
//         let nul_pos = byte_position(0, bytes);
...
//     ///
//     /// ```
//     /// use kernel_api::cstr::{CStr, CString};
//     ///
//     /// unsafe {
...
//     /// [`CString`]: struct.CString.html
//     #[inline]
//     pub const fn as_ptr(&self) -> *const CChar {
//         self.inner.as_ptr()
//     }
//
...
//         unsafe { &*(&self.inner as *const [CChar] as *const [u8]) }
//     }
//
